...
% maneuver from the driver is to temporarily move to another lane, drive
% past the obstacle, and move back to the original lane.
% 
% As part of the autonomous driving experience, an obstacle avoidance
...
%% Vehicle Model
% The ego car has a rectangular shape with a length of 5 meters and width of
...
% \end{array}$$
%% 
% The analytical Jacobians of nonlinear state-space model are used to
% construct the linear prediction model at the nominal operating point.
%
% $$\begin{array}{l}
