...
obstacles = obstaclesCreate({[50;0],[100;0]},{[5;0],[5;0]}, laneWidth);
...
for k = 1:length(T)
    ...
    % Update detections
    detections = obstaclesDetect(x, obstacles, laneWidth);
    [E,F,G] = ...
        obstaclesComputeCustomConstraint(x,detections,obstacles,laneWidth,lanes); 
